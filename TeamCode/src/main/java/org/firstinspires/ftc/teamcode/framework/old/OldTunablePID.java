...
public class OldTunablePID {
    ...
    public OldTunablePID(double p, double im, double dm) {
        proportional = p;
    ...
    public OldTunablePID(PIDConsts pidConsts) { // method overloading
        proportional = pidConsts.kP;
        integralMultiplier = pidConsts.kI;
        derivativeMultiplier = pidConsts.kD;
    }
